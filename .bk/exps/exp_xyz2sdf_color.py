...
from dataset.dataset_neus import MultiPatPatchDataset
...
from networks.neus.fields import SDFNetwork, SingleVarianceNetwork, ColorNetwork

# from networks.neus import SDFNetwork, SingleVarianceNetwork, NeuSLRenderer


# - Coding Part - #
class ExpXyz2SdfColorWorker(Worker):
    ...
    def init_dataset(self):
        ...
        self.pat_dataset = MultiPatPatchDataset(
    ...
    def init_networks(self):
        ...
        self.networks['ColorNetwork'] = ColorNetwork(
            d_feature=256,
            mode='no_view_dir',
            d_in=6,  # pts, normal
            d_out=5,  # a, b, rho, sigma_x, sigma_y
            d_hidden=256,
            n_layers=4,
    ...
    def net_forward(self, data):
        ...
        background_rgb = None
        render_out = self.renderer.render(  # TODO: Fix render core or create a new one.
            rays_o=data['rays_o'],
            rays_d=data['rays_v'],
